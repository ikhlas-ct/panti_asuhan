                        ...
                        <form action="{{ route('pegawai.update', $pegawai->id_pegawai) }}" method="POST"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="nama" name="nama"
                                            ...
                                            value="{{ old('nama', $pegawai->nama) }}" placeholder="Masukkan nama lengkap"
                                            required>
                                        @error('nama')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="nohp" name="nohp"
                                            ...
                                            value="{{ old('nohp', $pegawai->nohp) }}" placeholder="0812-3456-7890"
                                            maxlength="20">
                                        @error('nohp')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="deskripsi" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror"
                                    rows="4" placeholder="Masukkan deskripsi tentang pegawai">{{ old('deskripsi', $pegawai->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" id="instagram" name="instagram"
                                        ...
                                        value="{{ old('instagram', $pegawai->instagram) }}" placeholder="@username">
                                    @error('instagram')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" id="twitter" name="twitter"
                                        ...
                                        value="{{ old('twitter', $pegawai->twitter) }}" placeholder="@username">
                                    @error('twitter')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" id="facebook" name="facebook"
                                        ...
                                        value="{{ old('facebook', $pegawai->facebook) }}" placeholder="nama.profile">
                                    @error('facebook')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="card border-dashed p-3">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">
                                            ...
                                            Kosongkan jika tidak ingin mengubah. Format: JPEG, PNG, JPG. Maks. 2MB.
                                        </div>
                                        @error('foto_profil')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-12">
                                    <div class="section-header mb-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <h4 class="mb-0">Data User (Opsional)</h4>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="username" name="username"
                                            ...
                                            value="{{ old('username', $pegawai->user->username ?? '') }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="status" name="status"
                                            ...
                                            <option value="aktif"
                                                {{ old('status', $pegawai->user->status ?? '') == 'aktif' ? 'selected' : '' }}>
                                                Aktif
                                            </option>
                                            <option value="nonaktif"
                                                {{ old('status', $pegawai->user->status ?? '') == 'nonaktif' ? 'selected' : '' }}>
                                                Nonaktif
                                            </option>
                                        </select>
