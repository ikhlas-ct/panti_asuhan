            ...
            @forelse($heroSlides as $slide)
                <div class="carousel-slide">
                    ...
                    <div class="slide-content">
                        ...
                        <p>{{ $slide->description ?? 'Discover the indigenous tribe of Mentawai...' }}</p>
                        <a href="{{ $slide->button_link ?? '#culture' }}"
                            class="tribal-btn">{{ $slide->button_text ?? 'Explore Culture' }}</a>
                    </div>
                </div>
            @empty
                <div class="carousel-slide">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="culture-content">
                        ...
                        {!! $settings->paragraf_pengantar ??
                            '<p>The Mentawai people have preserved their ancient animist beliefs and traditions for thousands of years. Living in harmony with nature, they believe that all things – plants, animals, rocks, and rivers – have spirits.</p>' !!}
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="theme-card">
                            <div class="theme-icon">
                                <i class="{{ $theme->getIconClassAttribute() ?? 'fas fa-mountain' }}"></i>
                            </div>
                            <h3>{{ $theme->title }}</h3>
                    ...
                    <div class="col-lg-6">
                        <div class="service-item">
                            <div class="service-icon">
                                <i class="{{ $service->getIconClassAttribute() ?? 'fas fa-user-tie' }}"></i>
                            </div>
                            <h3>{{ $service->title }}</h3>
