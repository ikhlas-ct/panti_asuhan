  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav mx-auto gap-1">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('daftar-panti*') ? 'active' : '' }}" href="{{ route('daftar-panti') }}">Daftar Panti</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('kerjasama*') ? 'active' : '' }}" href="{{ route('kerjasama') }}">Kerjasama Kami</a>
        </li>
        <li class="nav-item">
      ...
      <div class="d-flex align-items-center gap-3 mt-3 mt-lg-0">
        ...
        @auth
          {{-- Tombol menuju dashboard sesuai role --}}
