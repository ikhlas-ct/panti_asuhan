...
<style>
    ...
    .form-control, .form-select {
        ...
        font-size:.83rem; padding:7px 12px; color:#334155;
    ...
    .table tbody td {
        ...
        font-size:.85rem; color:#334155; border-bottom:1px solid #f1f5f9;
    }
    ...
    .btn-action {
        ...
        align-items:center; justify-content:center;
        border-radius:8px; font-size:.75rem; padding:0; border:none;
    ...
    .btn-primary {
        ...
        padding:8px 18px; box-shadow:0 2px 8px rgba(26,115,232,.35);
    ...
    <div class="page-inner">
        ...
        <div class="card filter-card shadow-sm">
            ...
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">
                    <i class="fas fa-list text-primary me-2 opacity-75"></i>Daftar Panti Asuhan
                </h5>
                ...
                <form method="GET" action="{{ route('panti-asuhan.index') }}">
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-auto">
                            ...
                            <a href="{{ route('panti-asuhan.index') }}" class="btn btn-outline-secondary btn-sm ms-1" title="Reset">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- Nama --}}
                                <td>
                                    <div class="fw-semibold" style="font-size:.87rem;color:#1e293b;">{{ $panti->nama_panti }}</div>
                                    <div style="font-size:.75rem;color:#94a3b8;">{{ Str::limit($panti->alamat, 45) }}</div>
                                </td>
                                ...
                                <td>
                                    @if($panti->no_telp)
                                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $panti->no_telp) }}" target="_blank" style="font-size:.83rem;">
                                ...
                                {{-- Status --}}
                                <td>
                                    <span class="badge {{ $panti->status === 'aktif' ? 'badge-aktif' : 'badge-nonaktif' }}">
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        ...
                                        <button class="btn btn-action btn-hapus"
                                            data-id="{{ $panti->id }}" data-nama="{{ $panti->nama_panti }}" title="Hapus">
                            ...
                            <tr>
                                <td colspan="9" class="p-0 text-center">
                                    <div class="empty-state">
                                        ...
                                        <div class="fw-semibold text-secondary mb-1">Belum ada data panti asuhan</div>
            ...
            <div class="card-footer d-flex justify-content-between align-items-center flex-wrap gap-2">
                <small class="text-muted">
                    Menampilkan <strong>{{ $pantis->firstItem() }}</strong>–<strong>{{ $pantis->lastItem() }}</strong>
