...
<style>
    ...
    .ph-card.berita::before  { background:#1a73e8; }
    .ph-card.kegiatan::before { background:#16a34a; }
    .ph-left { display:flex; align-items:center; gap:12px; }
    .ph-icon {
        width:42px; height:42px; border-radius:10px;
        display:flex; align-items:center; justify-content:center; font-size:1rem; flex-shrink:0;
    }
    .ph-icon.berita   { background:#e8f0fe; color:#1a73e8; }
    .ph-icon.kegiatan { background:#dcfce7; color:#16a34a; }
    ...
    .main-card .card-header h5 { font-size:.93rem; font-weight:700; color:#1e293b; margin:0; }
    ...
    .input-group-text {
        ...
        border-radius:10px 0 0 10px; font-size:.8rem; color:#94a3b8;
    }
    ...
    /* ===== THUMBNAIL — sama persis pola anak asuh ===== */
    .thumb {
        width: 56px;
        height: 56px;
        object-fit: cover;
    ...
    /* ===== BTN PRIMARY ===== */
    .btn-primary {
        background: @if($jenis === 'berita') linear-gradient(135deg,#1a73e8,#1558b0) @else linear-gradient(135deg,#16a34a,#15803d) @endif;
        border:none; border-radius:10px; font-weight:600; font-size:.83rem;
        padding:8px 18px; transition:all .2s;
        box-shadow: @if($jenis === 'berita') 0 2px 8px rgba(26,115,232,.35) @else 0 2px 8px rgba(22,163,74,.35) @endif;
    }
    ...
    .name-text { font-weight:600; font-size:.84rem; color:#1e293b; }
    .sub-text  { font-size:.72rem; color:#94a3b8; margin-top:2px; }
</style>
@endsection
...
<div class="container">
    ...
    {{-- ── Page Header ── --}}
    <div class="ph-card {{ $jenis }}">
        <div class="ph-left">
            <div class="ph-icon {{ $jenis }}">
        ...
        <a href="{{ route('konten.create', $jenis) }}" class="btn btn-primary btn-sm">
    ...
    <div class="card main-card">
        ...
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5><i class="fas fa-list me-2 opacity-75"></i>Daftar {{ ucfirst($jenis) }}</h5>
        </div>
            ...
            <form method="GET" action="{{ route('konten.index', $jenis) }}">
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="{{ route('konten.index', $jenis) }}"
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- ── Sampul — pola sama persis dengan anak asuh ── --}}
                            <td>
                                @if($item->gambar)
                            ...
                            {{-- ── Judul ── --}}
                            <td>
                                <div class="name-text">{{ Str::limit($item->judul, 55) }}</div>
                                <div class="sub-text">
                            ...
                            <td>
                                <span style="font-size:.8rem;">
                                    {{ $item->pantiAsuhan?->nama_panti ?? 'Dinsos' }}
                                </span>
                            </td>
                            {{-- Tgl Mulai --}}
                        ...
                        @empty
                        <tr>
                            <td colspan="{{ $jenis === 'kegiatan' ? 8 : 8 }}" class="p-0">
