    ...
    <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
      <li class="nav-item topbar-user dropdown hidden-caret">
        <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
          <div class="avatar-sm">
            <img
              src="{{ Auth::user()->pegawai?->foto_profil
                ? asset('storage/' . Auth::user()->pegawai->foto_profil)
            ...
            <li>
              <div class="user-box">
                ...
                <div class="u-text">
                  ...
                  <p class="text-muted">{{ Auth::user()->pegawai?->email ?? Auth::user()->email ?? 'Tidak ada email' }}</p>
